...
public class Xml2ListBean {
    ...
    public JsonRootBean getJsonRootBean() throws Exception {

        String xmlStr = readFile(pathDir + "\\xml\\website.xml");
        Document doc = DocumentHelper.parseText(xmlStr);
        JSONObject json = new JSONObject();
        dom4j2Json(doc.getRootElement(), json);
        System.out.println(json.toJSONString());
        JsonRootBean jsonRootBean = JSONObject.parseObject(json.toJSONString(), JsonRootBean.class);
        return jsonRootBean;
